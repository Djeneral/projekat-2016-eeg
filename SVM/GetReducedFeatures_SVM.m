...
%           NumberOfEpochsUsed - Definiše broj epoha koje se koriste za
%           izvo?enje fi?er vektora.
...
%[col_id, row_id] = Char2ColRow (screen, 'Z'); % Odre?ivanje kolone i reda trenutnog slova
...
pos_epoch = epochs(pos_stimuli, 1:NumberOfEpochsUsed, :); % Odre?ivanje negativnih epoha na osnovu stimulusa
...
neg_epoch = epochs(neg_stimuli, 1:NumberOfEpochsUsed, :); % Odre?ivanje negativnih epoha na osnovu stimulusa
